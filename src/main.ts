...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const passwordInput = document.querySelector('.password-generator--input') as HTMLInputElement;
    ...
    const regeneratePasswordBtn = document.querySelector('.regenerate-password') as HTMLButtonElement;
    const copyBtn = document.querySelector('.copy-to-clipboard') as HTMLButtonElement;
